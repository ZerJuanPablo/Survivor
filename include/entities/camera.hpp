...
struct Camera {
    ...
    void bind() {
        ...
        // upload to GPU
        glUniformMatrix4fv(9, 1, false, glm::value_ptr(view_mat));
        glUniformMatrix4fv(13, 1, false, glm::value_ptr(_projection_mat));
        glUniform3f(17, _position.x, _position.y, _position.z);
    }
